...
import { 
    CalendarWrapper, Days, Day, ControlText, Control, Arrow, 
    CalendarBlock, Time, TimeSlots, TimeTitle, Label, 
    Checkbox, Visit 
} from "./styles";
        ...
        <Visit>
            ...
            <CalendarWrapper>
                <Control>
                    ...
                    <CalendarBlock>
                        <Arrow src={arrow}/><ControlText>December 2021</ControlText><Arrow src={arrow}/>
                    </CalendarBlock>
                </Control>
                <Days>
                    {days}
